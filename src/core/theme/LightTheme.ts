...
const colors = {
  gradients: {
    ...
    green2: 'linear-gradient(135deg, #00b09b, #96c93d)',
    black1: 'linear-gradient(135deg, #5c6284 0%, #223354 100%)',
  ...
  shadows: {
    ...
    headerPage: `0px 2px 4px -3px ${alpha(
      themeColors.black,
      0.1,
    )}, 0px 5px 12px -4px ${alpha(themeColors.black, 0.05)}`,
  },
  layout: {
    general: {
      bodyBg: '#f2f5f9',
  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: {
        ...
        '#nprogress .peg': {
          boxShadow: `0 0 15px ${colors.primary.main}, 0 0 8px${colors.primary.main}`,
        },
      ...
      styleOverrides: {
        root: {
          ...
          '& .MuiListItem-root.MuiButtonBase-root.Mui-selected': {
            backgroundColor: alpha(colors.primary.lighter, 1),
          },
